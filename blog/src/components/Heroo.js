...
export default class Heroo extends Component {
  ...
  <div class="container mx-auto flex flex-col  justify-center items-center">
    <div class="w-full md:w-2/3 flex flex-col mb-16 items-center font-bold text-center absolute">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900 ">Modish Makeover</h1>
